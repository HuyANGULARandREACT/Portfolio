      ...
      <div className="container py-5">
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <p
              className="mb-3"
              style={{ color: themeStyle.text, lineHeight: "1.6" }}
            >
            ...
            <div className="d-flex gap-3">
              <a
                href="https://github.com/HuyANGULARandREACT"
                target="_blank"
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="d-flex flex-column gap-2">
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                <small style={{ color: themeStyle.text }}>0823578239</small>
              </div>
              <div className="d-flex align-items-center gap-2">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-md-end">
              <small style={{ color: themeStyle.text }}>
                ...
                <FaCode style={{ color: "#e74c3c" }} /> {t("footer.by") || "by"}{" "}
                Nguyen Gia Huy
              </small>
            </div>
          </div>
